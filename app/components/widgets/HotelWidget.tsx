      ...
      <div className="relative">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="overflow-hidden rounded-xl border border-gray-200 bg-gradient-to-br from-white to-gray-50"
          >
            ...
            <div className="p-4">
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <h4 className="font-semibold text-gray-900">{currentHotel.name}</h4>
        ...
        {hotels.length > 1 && (
          <>
            <button
              onClick={prevHotel}
              className="absolute left-0 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-white p-2 shadow-lg transition-all hover:bg-gray-100 hover:shadow-xl"
            ...
            <button
              onClick={nextHotel}
              className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 rounded-full bg-white p-2 shadow-lg transition-all hover:bg-gray-100 hover:shadow-xl"
